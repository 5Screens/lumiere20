...
-- =====================================================
-- INCIDENT-SPECIFIC COLUMNS (stored in core_extended_attributes JSONB)
-- =====================================================
...
('tickets', 'Incident', NULL, NULL, 'rel_problem_id', 'incident.problem_id', 'Problème lié',
 ...
 'tickets', 'title', 'uuid', true, 'Problème connu lié à cet incident',
 true, 149,
 NULL, NULL, NULL),
...
('tickets', 'Incident', NULL, NULL, 'rel_change_request', 'incident.change_request', 'Demande de changement liée',
 ...
 'tickets', 'title', 'uuid', true, 'Changement à l''origine de l''incident',
 true, 150,
 NULL, NULL, NULL);
