...
BEGIN
    ...
    SELECT uuid INTO cab_uuid FROM configuration.groups WHERE group_name = 'Change Advisory Board' LIMIT 1;
    ...
    IF cab_uuid IS NULL THEN
        INSERT INTO configuration.groups (group_name, description, support_level, email, phone) 
