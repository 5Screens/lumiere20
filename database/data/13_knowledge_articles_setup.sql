...
VALUES 
    ...
    ('CONFIDENTIALITY_LEVEL', 'INTERNAL_RESTRICTED'),
    ('CONFIDENTIALITY_LEVEL', 'CONFIDENTIAL'),
    ('CONFIDENTIALITY_LEVEL', 'CONFIDENTIAL_HR'),
    ('CONFIDENTIALITY_LEVEL', 'SECRET'),
    ('CONFIDENTIALITY_LEVEL', 'TOP_SECRET'),
    ('CONFIDENTIALITY_LEVEL', 'SENSITIVE_PERSONAL_DATA'),
    ('CONFIDENTIALITY_LEVEL', 'REGULATED_INFO'),
    ('CONFIDENTIALITY_LEVEL', 'INTELLECTUAL_PROPERTY');
