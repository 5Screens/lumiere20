  ...
  static getRenderableFields(mode = 'for_creation') {
    ...
    const fields = {
      ...
      resolution_code: {
        ...
        endpoint: `incident_setup?lang=${userProfileStore.language}&metadata=RESOLUTION_CODE`,
        displayField: 'label',
        valueField: 'code',
      ...
      cause_code: {
        ...
        endpoint: `incident_setup?lang=${userProfileStore.language}&metadata=CAUSE_CODE`,
        displayField: 'label',
        valueField: 'code',
