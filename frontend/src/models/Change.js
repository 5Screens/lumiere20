...
export class Change {
  ...
  static getColumns() {
    ...
    return [
      ...
      { key: 'requested_by_name', label: t('change.requested_by'), visible: true },
      { key: 'requested_for_name', label: t('change.requested_for'), visible: true },
      { key: 'writer_name', label: t('change.writer'), visible: true },
      { key: 'ticket_type_label', label: t('change.ticket_type'), visible: true },
      ...
      { key: 'assigned_person_name', label: t('change.assigned_person'), visible: true },
      ...
      { key: 'change_justifications_label', label: t('change.justifications'), visible: true },
