...
export class Knowledge_article {
  ...
  static getColumns() {
    ...
    return [
      ...
      { key: 'rel_target_audience_label', label: t('knowledge_article.target_audience'), type: 'text', format: 'tags', filterKey: 'rel_target_audience' },
      { key: 'business_scope_label', label: t('knowledge_article.business_scope'), type: 'text', format: 'tags', filterKey: 'business_scope' },
