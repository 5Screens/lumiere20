export default {
  ...
  persons: {
    ...
    email:'Adresse e.mail',email_placeholder:'Entrez l\'adresse e-mail',
    business_phone:'Téléphone pro.',
    business_phone_placeholder:'Entrez le numéro de téléphone professionnel',
    personal_mobile_phone:'Téléphone personnel',
    personal_mobile_phone_placeholder:'Entrez le numéro de téléphone personnel',
    active:'Actif ?',
