export default {
  ...
  calendars: {
    ...
    parent: 'Calendrier parent',
    schedule: 'Planning',
    holidays: 'Jours fériés',
    messages: {
      created: 'Calendrier créé avec succès',
  ...
  workflow: {
    ...
    actions: {
      tabGeneral: 'Général',
      tabOnEnter: 'À l\'entrée',
      tabOnExit: 'À la sortie',
      tabActions: 'Actions',
      addAction: 'Ajouter une action',
      selectActionType: 'Choisissez le type d\'action à ajouter.',
      label: 'Libellé',
      labelHint: 'Libellé personnalisé optionnel pour cette étape.',
      noActions: 'Aucune action configurée.',
      onEnterDescription: 'Actions exécutées à l\'entrée dans ce statut.',
      onExitDescription: 'Actions exécutées à la sortie de ce statut.',
      onTransitionDescription: 'Actions exécutées lorsque cette transition est déclenchée.',
      categories: {
        data: 'Données',
        approval: 'Approbation',
        wait: 'Attente',
        logic: 'Logique de flux',
        notification: 'Notifications',
        integration: 'Intégration',
        system: 'Système'
      },
      types: {
        look_up_record: 'Rechercher un enregistrement',
        ...
        log: 'Journal',
        ask_for_approval: 'Demander une approbation',
        wait_for_condition: 'Attendre une condition',
        wait_for_duration: 'Attendre une durée',
        if_condition: 'Si / Sinon',
        for_each: 'Pour chaque',
        parallel: 'Parallèle',
        assign_values: 'Affecter des valeurs',
        send_email: 'Envoyer un email',
        send_notification: 'Envoyer une notification',
        rest_step: 'Appel REST'
      },
      descriptions: {
        look_up_record: 'Rechercher un enregistrement dans le système',
        create_record: 'Créer un nouvel enregistrement',
        update_record: 'Mettre à jour un enregistrement existant',
        delete_record: 'Supprimer un enregistrement',
        log: 'Écrire un message dans le journal système',
        ask_for_approval: 'Demander l\'approbation d\'un utilisateur ou groupe',
        wait_for_condition: 'Attendre qu\'une condition soit satisfaite',
        wait_for_duration: 'Attendre pendant une durée définie',
        if_condition: 'Branchement conditionnel (si/sinon)',
        for_each: 'Boucle sur une liste d\'enregistrements',
        parallel: 'Exécuter des branches en parallèle',
        assign_values: 'Affecter des valeurs aux variables du flux',
        send_email: 'Envoyer une notification par email',
        send_notification: 'Envoyer une notification dans l\'application',
        rest_step: 'Appeler une API REST externe'
      }
    }
  },
  audit: {
...
userSets: {
  ...
  serviceSubscriptions: 'Souscriptions de service',
  isFilterByRole: 'Filtrer par rôle',
  filterRole: 'Rôles',
  isFilterByLanguage: 'Filtrer par langue',
  filterLanguage: 'Langues',
  isFilterByEntity: 'Filtrer par entité',
  filterEntity: 'Entités',
  isFilterByLocation: 'Filtrer par site',
  filterLocation: 'Sites',
  isFilterByApprovingManager: 'Filtrer par manager approbateur',
  filterApprovingManager: 'Managers approbateurs',
  isFilterByIsActive: 'Filtrer par statut actif',
  filterIsActive: 'Actif',
  isFilterByCriticalUser: 'Filtrer par utilisateur critique',
  filterCriticalUser: 'Utilisateur critique',
  isFilterByExternalUser: 'Filtrer par utilisateur externe',
  filterExternalUser: 'Utilisateur externe',
  isFilterByEmail: 'Filtrer par email',
  filterEmail: 'Motif email',
  messages: {
