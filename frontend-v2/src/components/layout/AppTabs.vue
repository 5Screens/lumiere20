...
.dark :deep(.p-tab.p-tab-active) {
  background: var(--p-primary-900);
  color: var(--p-primary-300);
}

/* Child tabs - smaller ink bar */
.bg-surface-50 + :deep(.p-tabpanels) .p-tabs-ink-bar,
:deep(.p-tablist.bg-surface-50) ~ .p-tabs-ink-bar {
  height: 2px;
}
