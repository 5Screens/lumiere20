export default {
  ...
  ciTypes: {
    title: 'Types de CI',
    ups: 'Onduleur (UPS)',
    upsDesc: 'Alimentation sans interruption',
    application: 'Application',
    applicationDesc: 'Application logicielle',
    server: 'Serveur',
    serverDesc: 'Serveur physique ou virtuel',
    networkDevice: 'Équipement réseau',
    networkDeviceDesc: 'Routeur, switch, firewall, etc.',
    storage: 'Stockage',
    storageDesc: 'SAN, NAS, baies de stockage',
    workstation: 'Poste de travail',
    workstationDesc: 'Ordinateur de bureau ou portable',
    printer: 'Imprimante',
    printerDesc: 'Imprimante ou multifonction',
    mobileDevice: 'Appareil mobile',
    mobileDeviceDesc: 'Smartphone, tablette',
    database: 'Base de données',
    databaseDesc: 'Instance de base de données',
    generic: 'Générique',
    genericDesc: 'Élément de configuration générique',
    code: 'Code',
