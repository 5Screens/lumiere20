...
async function seedObjectMetadata() {
  ...
  const fieldsByObjectType = {
    ...
    ci_types: [
      ...
      { field_name: 'icon', label_key: 'ciTypes.icon', field_type: 'text', min_width: '8rem', display_order: 4 },
      { field_name: 'color', label_key: 'ciTypes.color', field_type: 'text', min_width: '8rem', display_order: 5 },
      { field_name: 'is_active', label_key: 'common.isActive', field_type: 'boolean', data_type: 'boolean', min_width: '6rem', display_order: 6 },
