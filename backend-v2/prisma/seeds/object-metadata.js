...
async function seedObjectMetadata() {
  ...
  const fieldsByObjectType = {
    configuration_items: [
      { field_name: 'name', label_key: 'configurationItems.name', field_type: 'text', is_required: true, is_translatable: true, min_width: '16rem', display_order: 1, default_visible: false },
      { field_name: 'ci_type', label_key: 'configurationItems.ciType', field_type: 'select', min_width: '10rem', display_order: 2, options_source: '/ci_types/options', default_visible: false },
      ...
      { field_name: 'rel_status_uuid', label_key: 'workflow.status', field_type: 'workflow_status', show_in_table: true, default_visible: false, min_width: '10rem', display_order: 4 },
      { field_name: 'description', label_key: 'configurationItems.description', field_type: 'textarea', is_translatable: true, min_width: '20rem', display_order: 5 },
    ...
    tickets: [
      { field_name: 'title', label_key: 'tickets.title', field_type: 'text', is_required: true, show_in_table: true, default_visible: false, min_width: '16rem', display_order: 1 },
      ...
      { field_name: 'rel_status_uuid', label_key: 'workflow.status', field_type: 'workflow_status', show_in_table: true, default_visible: false, min_width: '10rem', display_order: 4 },
      { field_name: 'writer_uuid', label_key: 'tickets.writer', field_type: 'person', is_required: true, is_editable: false, show_in_table: true, default_visible: true, min_width: '20rem', display_order: 5 },
      { field_name: 'requested_by_uuid', label_key: 'tickets.requestedBy', field_type: 'person', show_in_table: true, default_visible: false, min_width: '20rem', display_order: 6 },
      { field_name: 'requested_for_uuid', label_key: 'tickets.requestedFor', field_type: 'person', show_in_table: true, default_visible: false, min_width: '20rem', display_order: 7 },
      { field_name: 'configuration_item_uuid', label_key: 'tickets.configurationItem', field_type: 'configuration_item', show_in_table: true, default_visible: true, min_width: '20rem', display_order: 8 },
      { field_name: 'assigned_group_uuid', label_key: 'tickets.assignedGroup', field_type: 'group', show_in_table: true, default_visible: false, min_width: '20rem', display_order: 9 },
      { field_name: 'assigned_person_uuid', label_key: 'tickets.assignedPerson', field_type: 'person', show_in_table: true, default_visible: true, min_width: '20rem', display_order: 10 },
      { field_name: 'watchers', label_key: 'tickets.watchers', field_type: 'person_multiple', min_width: '14rem', display_order: 11, show_in_table: false, default_visible: false },
      { field_name: 'attachments', label_key: 'tickets.attachments', field_type: 'attachments', min_width: '14rem', display_order: 12, show_in_table: false, default_visible: false },
      { field_name: 'closed_at', label_key: 'tickets.closedAt', field_type: 'datetime', data_type: 'date', is_editable: false, min_width: '12rem', display_order: 13, show_in_table: true, default_visible: false },
      { field_name: 'created_at', label_key: 'common.createdAt', field_type: 'datetime', data_type: 'date', is_editable: false, show_in_form: false, show_in_table: true, default_visible: false, min_width: '12rem', display_order: 20 },
    ...
    object_setup: [
      { field_name: 'object_type', label_key: 'objectSetup.objectType', field_type: 'select', is_required: true, min_width: '10rem', display_order: 1, is_filterable: true, options_source: JSON.stringify([
