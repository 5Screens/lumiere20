...
async function seedObjectMetadata() {
  ...
  const fieldsByObjectType = {
    ...
    tasks: [
      { field_name: 'title', label_key: 'tasks.title', field_type: 'text', is_required: true, show_in_table: true, default_visible: true, min_width: '16rem', display_order: 1 },
      { field_name: 'description', label_key: 'tasks.description', field_type: 'textarea', min_width: '20rem', display_order: 2, show_in_table: true, default_visible: true },
      { field_name: 'ticket_type_code', label_key: 'tasks.ticketType', field_type: 'text', is_editable: false, show_in_table: false, show_in_form: false, default_visible: false, display_order: 3 },
      { field_name: 'rel_status_uuid', label_key: 'tasks.status', field_type: 'workflow_status', show_in_table: true, default_visible: true, min_width: '10rem', display_order: 4 },
      { field_name: 'writer_uuid', label_key: 'tasks.writer', field_type: 'person', is_required: true, is_editable: false, show_in_table: true, default_visible: true, min_width: '12rem', display_order: 5 },
      { field_name: 'requested_by_uuid', label_key: 'tasks.requestedBy', field_type: 'person', show_in_table: true, default_visible: true, min_width: '12rem', display_order: 6 },
      { field_name: 'requested_for_uuid', label_key: 'tasks.requestedFor', field_type: 'person', show_in_table: true, default_visible: true, min_width: '12rem', display_order: 7 },
      { field_name: 'configuration_item_uuid', label_key: 'tasks.configurationItem', field_type: 'configuration_item', show_in_table: true, default_visible: true, min_width: '14rem', display_order: 8 },
      { field_name: 'watchers', label_key: 'tasks.watchers', field_type: 'person_multiple', min_width: '14rem', display_order: 9, show_in_table: false, default_visible: false },
      { field_name: 'attachments', label_key: 'tasks.attachments', field_type: 'attachments', min_width: '14rem', display_order: 10, show_in_table: false, default_visible: false },
      { field_name: 'closed_at', label_key: 'tasks.closedAt', field_type: 'datetime', data_type: 'date', is_editable: false, min_width: '12rem', display_order: 11, show_in_table: true, default_visible: true },
