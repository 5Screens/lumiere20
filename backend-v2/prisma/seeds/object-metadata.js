...
async function seedObjectMetadata() {
  ...
  const fieldsByObjectType = {
    ...
    tickets: [
      ...
      { field_name: 'rel_status_uuid', label_key: 'workflow.status', field_type: 'workflow_status', show_in_table: true, default_visible: true, min_width: '10rem', display_order: 4 },
      { field_name: 'writer_uuid', label_key: 'tickets.writer', field_type: 'person', is_required: true, is_editable: false, show_in_table: true, default_visible: true, min_width: '12rem', display_order: 5 },
      { field_name: 'requested_by_uuid', label_key: 'tickets.requestedBy', field_type: 'person', show_in_table: true, default_visible: true, min_width: '12rem', display_order: 6 },
      { field_name: 'requested_for_uuid', label_key: 'tickets.requestedFor', field_type: 'person', show_in_table: true, default_visible: true, min_width: '12rem', display_order: 7 },
      { field_name: 'configuration_item_uuid', label_key: 'tickets.configurationItem', field_type: 'configuration_item', show_in_table: true, default_visible: true, min_width: '14rem', display_order: 8 },
      { field_name: 'assigned_group_uuid', label_key: 'tickets.assignedGroup', field_type: 'group', show_in_table: true, default_visible: true, min_width: '12rem', display_order: 9 },
      { field_name: 'assigned_person_uuid', label_key: 'tickets.assignedPerson', field_type: 'person', show_in_table: true, default_visible: true, min_width: '12rem', display_order: 10 },
