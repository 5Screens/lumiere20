...
async function seedObjectMetadata() {
  ...
  const fieldsByObjectType = {
    ...
    tickets: [
      ...
      { field_name: 'requested_by_uuid', label_key: 'tickets.requestedBy', field_type: 'person', show_in_table: true, default_visible: true, min_width: '20rem', display_order: 6 },
      { field_name: 'requested_for_uuid', label_key: 'tickets.requestedFor', field_type: 'person', show_in_table: true, default_visible: true, min_width: '20rem', display_order: 7 },
      ...
      { field_name: 'assigned_group_uuid', label_key: 'tickets.assignedGroup', field_type: 'group', show_in_table: true, default_visible: true, min_width: '20rem', display_order: 9 },
