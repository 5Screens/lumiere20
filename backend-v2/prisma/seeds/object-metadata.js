...
async function seedObjectMetadata() {
  ...
  const fieldsByObjectType = {
    configuration_items: [
      ...
      { field_name: 'rel_model_uuid', label_key: 'configurationItems.model', field_type: 'ci_model', min_width: '14rem', display_order: 3, show_in_table: false, default_visible: true },
    ...
    ci_types: [
      ...
      { field_name: 'rel_category_uuid', label_key: 'ciTypes.category', field_type: 'ci_category', min_width: '10rem', display_order: 4, default_visible: true },
