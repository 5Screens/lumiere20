...
async function seedObjectMetadata() {
  ...
  const fieldsByObjectType = {
    configuration_items: [
      ...
      { field_name: 'is_model_for_ci_type_uuid', label_key: 'configurationItems.isModelFor', field_type: 'ci_type_target', min_width: '14rem', display_order: 3, show_in_table: false },
      { field_name: 'rel_model_uuid', label_key: 'configurationItems.model', field_type: 'ci_model', min_width: '14rem', display_order: 4, show_in_table: false },
    ...
    ci_types: [
      ...
      { field_name: 'icon', label_key: 'ciTypes.icon', field_type: 'icon_picker', min_width: '8rem', display_order: 5 },
      { field_name: 'color', label_key: 'ciTypes.tagStyle', field_type: 'tag_style', min_width: '8rem', display_order: 6 },
      { field_name: 'is_active', label_key: 'common.isActive', field_type: 'boolean', data_type: 'boolean', min_width: '6rem', display_order: 7 },
      { field_name: 'display_order', label_key: 'ciTypes.displayOrder', field_type: 'number', data_type: 'number', min_width: '8rem', display_order: 8 },
      { field_name: 'created_at', label_key: 'common.createdAt', field_type: 'datetime', data_type: 'date', is_editable: false, show_in_form: false, min_width: '12rem', display_order: 10 },
      { field_name: 'updated_at', label_key: 'common.updatedAt', field_type: 'datetime', data_type: 'date', is_editable: false, show_in_form: false, min_width: '12rem', display_order: 11 },
    ],
    ci_categories: [
