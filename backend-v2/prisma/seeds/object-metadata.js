...
async function seedObjectMetadata() {
  ...
  const fieldsByObjectType = {
    ...
    ci_types: [
      ...
      { field_name: 'label_key', label_key: 'ciTypes.labelKey', field_type: 'text', is_required: true, min_width: '14rem', display_order: 2 },
      { field_name: 'description_key', label_key: 'ciTypes.descriptionKey', field_type: 'text', min_width: '14rem', display_order: 3 },
      { field_name: 'icon', label_key: 'ciTypes.icon', field_type: 'icon_picker', min_width: '8rem', display_order: 4 },
      { field_name: 'color', label_key: 'ciTypes.tagStyle', field_type: 'tag_style', min_width: '8rem', display_order: 5 },
      { field_name: 'is_active', label_key: 'common.isActive', field_type: 'boolean', data_type: 'boolean', min_width: '6rem', display_order: 6 },
      { field_name: 'display_order', label_key: 'ciTypes.displayOrder', field_type: 'number', data_type: 'number', min_width: '8rem', display_order: 7 },
      { field_name: 'created_at', label_key: 'common.createdAt', field_type: 'datetime', data_type: 'date', is_editable: false, show_in_form: false, min_width: '12rem', display_order: 10 },
      { field_name: 'updated_at', label_key: 'common.updatedAt', field_type: 'datetime', data_type: 'date', is_editable: false, show_in_form: false, min_width: '12rem', display_order: 11 },
    ],
  };
