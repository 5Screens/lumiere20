...
async function seedObjectMetadata() {
  ...
  const fieldsByObjectType = {
    ...
    tickets: [
      ...
      { field_name: 'assigned_to_group', label_key: 'tickets.assignedGroup', field_type: 'group', show_in_table: true, default_visible: true, min_width: '12rem', display_order: 9 },
      { field_name: 'assigned_to_person', label_key: 'tickets.assignedPerson', field_type: 'person', show_in_table: true, default_visible: true, min_width: '12rem', display_order: 10 },
