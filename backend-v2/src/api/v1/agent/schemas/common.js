...
const INTENT_TOOL_MAPPING = {
  [INTENTS.SEARCH_SOLUTION]: ['semantic_search_kb', 'generate_solution_steps'], // Note: if semantic_search_kb finds nothing, direct_llm_query is called automatically (see service.js)
