...
const validateGetIncidentImpacts = async (req, res, next) => {
    logger.info('[VALIDATION] Validating get incident impacts request');
    ...
    try {
        ...
        logger.info('[VALIDATION] Get incident impacts request validation successful');
        next();
    } catch (error) {
