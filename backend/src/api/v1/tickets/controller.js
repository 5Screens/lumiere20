...
const createTicket = async (req, res) => {
    try {
        ...
        logger.info(`[CONTROLLER] Processing POST /tickets request${isIncidentFromQuery ? ' for INCIDENT type (from query)' : ''}${isIncidentFromBody ? ' for INCIDENT type (from body)' : ''}`);
