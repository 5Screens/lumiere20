...
async function seedObjectMetadata() {
  ...
  const fieldsByObjectType = {
    ...
    calendars: [
      ...
      { field_name: 'timezone', label_key: 'calendars.timezone', field_type: 'text', is_required: true, min_width: '12rem', display_order: 3, default_visible: true },
      ...
      { field_name: 'schedule', label_key: 'calendars.schedule', field_type: 'json', min_width: '20rem', display_order: 5, show_in_table: false, default_visible: true },
      { field_name: 'holidays', label_key: 'calendars.holidays', field_type: 'json', min_width: '20rem', display_order: 6, show_in_table: false, default_visible: true },
